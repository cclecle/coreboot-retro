...
#include <string.h>
 ...
 const struct irq_routing_table intel_irq_routing_table = {
				  ...
				  */
	 {
		 ...
		 //{0x00, (0x00 << 3) | 0x0, {{0x60, 0xdeb8}, {0x61, 0xdeb8}, {0x62, 0xdeb8}, {0x63, 0xdeb8}}, 0x0, 0x0},

		 // PCI/AGP bridge
		 {0x00, (0x01 << 3) | 0x0, {{0x60, 0xdeb8}, {0x61, 0xdeb8}, {0x62, 0xdeb8}, {0x63, 0xdeb8}}, 0x0, 0x0},

		 // ISA Bridge
		 {0x00, (0x02 << 3) | 0x0, {{0x60, 0xdeb8}, {0x61, 0xdeb8}, {0x62, 0xdeb8}, {0x63, 0xdeb8}}, 0x0, 0x0},

		 // ??  => DISABLED ?
		 //{0x00, (0x03 << 3) | 0x0, {{0x63, 0xdeb8}, {0x00, 0x0000}, {0x00, 0x0000}, {0x00, 0x0000}}, 0x0, 0x0},

		 // Actual ports
		 {0x00, (0x0e << 3) | 0x0, {{0x60, 0xdeb8}, {0x61, 0xdeb8}, {0x62, 0xdeb8}, {0x63, 0xdeb8}}, 0x1, 0x0},
		 {0x00, (0x0c << 3) | 0x0, {{0x61, 0xdeb8}, {0x62, 0xdeb8}, {0x63, 0xdeb8}, {0x60, 0xdeb8}}, 0x2, 0x0},
		 {0x00, (0x0a << 3) | 0x0, {{0x62, 0xdeb8}, {0x63, 0xdeb8}, {0x60, 0xdeb8}, {0x61, 0xdeb8}}, 0x3, 0x0},

		 // ??  => DISABLED ?
		 //{0x01, (0x01 << 3) | 0x0, {{0x61, 0xdeb8}, {0x00, 0x0000}, {0x00, 0x0000}, {0x00, 0x0000}}, 0x0, 0x0},
		 //{0x01, (0x00 << 3) | 0x0, {{0x60, 0xdeb8}, {0x61, 0xdeb8}, {0x00, 0x0000}, {0x00, 0x0000}}, 0x6, 0x0},
	 }
 };
...
unsigned long write_pirq_routing_table(unsigned long addr)
{
	...
	// pci slot 1
	//{0x00, (0x14 << 3) | 0x0, {{0x60, 0xdeb8}, {0x61, 0xdeb8}, {0x62, 0xdeb8}, {0x63, 0xdeb8}}, 0x1, 0x0},
	write_pirq_info(pirq_info, 0, PCI_DEVFN(0x0e, 0),
			0x60, 0xdeb8, 0x61, 0xdeb8, 0x62, 0xdeb8, 0x63, 0xdeb8, 1, 0);
	pirq_info++;
	slot_num++;

	// pci slot 2
	//{0x00, (0x12 << 3) | 0x0, {{0x61, 0xdeb8}, {0x62, 0xdeb8}, {0x63, 0xdeb8}, {0x60, 0xdeb8}}, 0x2, 0x0},
	...
	// pci slot 3
	//{0x00, (0x10 << 3) | 0x0, {{0x62, 0xdeb8}, {0x63, 0xdeb8}, {0x60, 0xdeb8}, {0x61, 0xdeb8}}, 0x3, 0x0},
